...
function OP(shareDate='2021-06-08'){
        let List = ['53crqcbzjdxoubw3b7uza4hzwq5ac3f4ijdgqji','euwpuowjqkfmnycxuxurcufmi45ac3f4ijdgqji'];
        for (let i in List) {
          if (List[i]) help(List[i], shareDate);
          $.wait(1000);
        }
}
