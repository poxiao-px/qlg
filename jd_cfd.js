...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/spiritvoid/jd_zoo/main/jd_cfd.txt")
  $.strMyShareIds = [...(res2 && res2.shareId || [])]
  $.strGroupIds = [...(res2 && res2.strGroupIds || [])]
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      $.newShareCodes = [...$.strMyShareIds, "28BDB1F62FC529CB2D909ACB7DC12A1FB2456645947B9D09E476B0A9813500E9","C441BFDB867D326FFCFB86A01E2EC781A961E340813D35F4DFFC9B5EF542FAE7"];
    }
