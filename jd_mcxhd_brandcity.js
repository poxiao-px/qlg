...
[task_local]
#新潮品牌狂欢
tag=新潮品牌狂欢, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
!(async () => {
    ...
    if(l!=999)
    {
        L = ['43xA_erJaPow6F86M-TPfcra7P1mcQJC_f4N5fQ0-00i6gXanOJa20oqw-YomskZ3E6A','43xA_erJaPow6F86M-TF-gdaoClCBEKrJHZW7SaECz6N1oXanOJ63kpPAZ_sRPUrLbIw'];
        status=  await doTask("mcxhd_brandcity_doTask",`{"itemToken":"${L[0]}","token":"jd17919499fb7031e5"}`)
        await $.wait(500);
        status=  await doTask("mcxhd_brandcity_doTask",`{"itemToken":"${L[1]}","token":"jd17919499fb7031e5"}`)
        await $.wait(500);
    }
